...
// > #define DEFAULT_MAX_FEEDRATE {200, 200, 3, 25} // (mm/sec) CL: default for HIC i3
// > 
...
//> // default jerk values for HIC i3 was ={20.0, 0.4, 5.0} (mm/sec)
